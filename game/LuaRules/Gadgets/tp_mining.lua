...
local debug = false
-----config-----
local miner_name =  {}--{"bminer", "kdroneminingtower", "lobelisk", "kdroneminerflyer"}      --the unit used for mining
local resource_name = {}--{"bminerals","bmeteorimpact","bmeteorimpact_big"}     --the stuff that gets mined
local dropoff_name = {}--{"bsupplydepot", "bsupplydepotai", "bprimarycruiserbase", "bprimarycruiserbaseai", "kdroneminingtower","lobelisk", "kdronemininghub"} --where the miners bring the resources to
...
function nearest_resID_from_miner (minerID)
    ...
    res=Spring.GetUnitsInCylinder (x,z, 500, Spring.GetGaiaTeamID())
