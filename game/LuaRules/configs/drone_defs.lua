local carrierDefs = {
        ...
        {hostUnitDefID = UnitDefNames.lobelisk.id, droneUnitDefID=UnitDefNames.lstemcell.id, reloadTime = 2, maxDrones = 4,  managed=false, hostUnitID = nil, drones = {  }, reload = nil, selectMode=1},
}
