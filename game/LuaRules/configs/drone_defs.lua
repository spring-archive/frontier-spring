local carrierDefs = {
        ...
        {hostUnitDefID = UnitDefNames.lobelisk.id, droneUnitDefID=UnitDefNames.lstemcell.id, reloadTime = 40, maxDrones = 20,  managed=false, hostUnitID = nil, drones = {  }, reload = nil, selectMode=1},
}
